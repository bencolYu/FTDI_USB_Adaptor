...
Summary calculations use all captured samples.
    ...
    parser.add_argument('--ad5245-step', type=int, default=AD5245_STEP_VALUE,
                        help=f'AD5245 coarse increment step (default: {AD5245_STEP_VALUE})')
    parser.add_argument('--ad5245-fine-step', type=int, default=AD5245_FINE_STEP_VALUE,
                        help=f'AD5245 fine increment step (default: {AD5245_FINE_STEP_VALUE})')
    parser.add_argument('--ad5245-fine-threshold', type=float, default=AD5245_FINE_THRESHOLD_V,
                        help=f'Switch to fine step when piezo_volt_set-rms_a_v is below this voltage (default: {AD5245_FINE_THRESHOLD_V})')
    ...
    if args.ad5245_fine_step <= 0:
        parser.error('--ad5245-fine-step must be positive')
    if args.ad5245_fine_threshold < 0:
        parser.error('--ad5245-fine-threshold must be zero or positive')
        ...
        for freq_hz in points:
            ...
            try:
                ...
                while ad5245_value <= args.ad5245_max:
                    ...
                    print(f'  Setting AD5245 to {ad5245_value} (step {ad5245_step})...')
                    set_ad5245_value(
                    ...
                    if selected_stats['rms_a_v'] >= args.piezo_volt_set:
                        break
                    error_to_target = args.piezo_volt_set - selected_stats['rms_a_v']
                    if (error_to_target < args.ad5245_fine_threshold and
                            ad5245_step != args.ad5245_fine_step):
                        print(
                            f'    Within {args.ad5245_fine_threshold:.6f} V of target; '
                            f'switching AD5245 step to {args.ad5245_fine_step}')
                        ad5245_step = args.ad5245_fine_step
                    next_ad5245_value = ad5245_value + ad5245_step
                    if next_ad5245_value > args.ad5245_max and ad5245_value != args.ad5245_max:
                        ad5245_value = args.ad5245_max
                    else:
                        ad5245_value = next_ad5245_value
